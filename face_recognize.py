...
my_image = face_recognition.load_image_file("C:/Users/99025/Desktop/1.jpg")
my_face_encoding = face_recognition.face_encodings(my_image)[0]

me_image = face_recognition.load_image_file("C:/Users/99025/Desktop/2.jpg")
me_face_encoding = face_recognition.face_encodings(me_image)[0]

Leonard_image = face_recognition.load_image_file("C:/Users/99025/Desktop/1.jpg")
...
while True:
    ...
    if t:
        ...
        for face_encoding in face_encodings:
            ...
            matches = face_recognition.compare_faces(known_face_encodings, face_encoding,
                                                     tolerance=0.4)  # 人脸对比函数  对比那128个向量  返回一个True/False的列表，第一个参数为已知的编码过的人脸列表，第二个是未知的编码过的人脸，第三个tolerance=0.6人脸对比的严格度，越低越严格
            name = "Unknown"
    ...
    for (top, right, bottom, left), name in zip(face_locations,
        ...
        cv2.rectangle(frame, (left, top), (right, bottom), (0, 255, 0),
                      2)  # 画出人脸矩形框    第一个参数是图片 第二个（left, top）是矩阵的左上点坐标  第三个（right, bottom）是矩阵的右下点坐标  第三个是画线对应的bgr颜色  第四个是所画的线的宽度

        # 在人脸框下面"画"出名字
        cv2.rectangle(frame, (left, bottom - 35), (right, bottom), (0, 255, 0), cv2.FILLED)
        font = cv2.FONT_HERSHEY_DUPLEX
        cv2.putText(frame, name, (left + 6, bottom - 6), font, 1.0, (255, 255, 255),
                    1)  # 各参数依次是：照片/添加的文字/左上角坐标/字体/字体大小/颜色/字体粗细
